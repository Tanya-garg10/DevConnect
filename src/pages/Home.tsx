            ...
            <div className="hidden md:block">
              <div className="bg-linear-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-900/30 rounded-lg p-8 font-mono text-sm text-gray-300">
                ...
                <div className="text-cyan-400 mt-2">
                  const developer = <span className="text-emerald-400">{'{}'}</span>
                </div>
                <div className="ml-4 text-gray-400 mt-1">
                  skills: <span className="text-emerald-400">['web', 'mobile', 'ml']</span>
                </div>
                <div className="ml-4 text-gray-400">
                  ideas: <span className="text-emerald-400">['innovative', 'scalable']</span>
                </div>
                <div className="text-cyan-400 mt-2">
                  share<span className="text-emerald-400">.</span>build<span className="text-emerald-400">.</span>grow()
                </div>
              </div>
            </div>
          </div>
